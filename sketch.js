...
boy.scale = (2);
 ...
 healthBar1.shapeColor = "white";
  ...
  healthBar2 = createSprite(windowWidth-205,100,300,25);
  healthBar2.shapeColor = "white";

  healthLevel2 = createSprite(windowWidth-205,100,290,15);
  healthLevel2.shapeColor = "red";

  healthBlock2 = createSprite(windowWidth-70,100,40,45);
